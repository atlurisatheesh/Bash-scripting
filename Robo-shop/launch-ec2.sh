...
COMPONENT=$1 
ENV=$2
HOSTEDZONEID="Z07241042EY8SI8OK4C8B"
...
SG_ID="$(aws ec2 describe-security-groups  --filters Name=group-name,Values=devops-allow-all | jq '.SecurityGroups[].GroupId' | sed -e 's/"//g')"       # b54-allow-all security group id
